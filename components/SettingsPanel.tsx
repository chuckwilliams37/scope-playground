            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <label className="text-sm font-medium text-gray-900 cursor-pointer" htmlFor="client-safe-checkbox">
                    Client-Safe Mode
                  </label>
                </div>
                <p className="text-sm text-gray-700 mb-3">
                  When enabled, hourly rates and internal calculation details are hidden from the UI and all exports (PDF, CSV, share links).
                </p>
                <div className="flex items-center gap-2">
                  <input
                    id="client-safe-checkbox"
                    type="checkbox"
                    checked={clientSafeMode}
                    onChange={(e) => toggleClientSafeMode(e.target.checked)}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded cursor-pointer"
                  />
                  <label htmlFor="client-safe-checkbox" className="text-sm text-gray-700 cursor-pointer">
                    Hide sensitive financial details
                  </label>
                </div>
                <div className="mt-2">
                  <a 
                    href="/CLIENT_SAFE_MODE.md" 
                    target="_blank" 
